...
import ru.nau.spring_ai_workshop.repository.DocumentRepository;
    ...
    public void loadDocuments() {
        ...
        resources.stream()
                ...
                .forEach(pair -> {
                    ...
                    // TODO: оптимизировать логику обработки документа
                    //  (если в документе изменится одно слово, то придется заново нарезать весь файл на чанки и сохранять их все)
